...
<?php endif; ?>
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                ...
                <span class="ml-2 text-sm text-gray-600 pooortext-gray-400"><?php echo e(__('Nhớ mật khẩu')); ?></span>
            </label>
        </div>

        <div class="flex items-center justify-end mt-4">
            <?php if(Route::has('password.request')): ?>
            <a class="underline text-sm text-gray-600 pooortext-gray-400 hover:text-gray-900 pooorhover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 pooorfocus:ring-offset-gray-800" href="<?php echo e(route('password.request')); ?>">
...
<?php endif; ?><?php /**PATH D:\Workspace\Shopi\resources\views/auth/login.blade.php ENDPATH**/ ?>