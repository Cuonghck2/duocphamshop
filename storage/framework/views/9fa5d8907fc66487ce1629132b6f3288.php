...
<div wire:key="<?php echo e($this->id); ?>.table.record.<?php echo e($recordKey); ?>.column.<?php echo e($getName()); ?>.toggle-column.<?php echo e($state ? 'true' : 'false'); ?>">
    <div
        x-data="{
            error: undefined,
...
<?php /**PATH D:\Workspace\Shopi\vendor\filament\tables\src\/../resources/views/columns/toggle-column.blade.php ENDPATH**/ ?>