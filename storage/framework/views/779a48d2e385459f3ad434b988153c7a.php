...
} elseif ($_instance->childHasBeenRendered('SIxfW7J')) {
    $componentId = $_instance->getRenderedChildComponentId('SIxfW7J');
    $componentTag = $_instance->getRenderedChildComponentTagName('SIxfW7J');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('SIxfW7J');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('SIxfW7J', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('Fqym1tC')) {
    $componentId = $_instance->getRenderedChildComponentId('Fqym1tC');
    $componentTag = $_instance->getRenderedChildComponentTagName('Fqym1tC');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Fqym1tC');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('Fqym1tC', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH D:\Workspace\Shopi\vendor\filament\filament\src\/../resources/views/components/topbar.blade.php ENDPATH**/ ?>